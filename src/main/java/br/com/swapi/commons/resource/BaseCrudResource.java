...
public abstract class BaseCrudResource<E extends BaseEntity, P extends BaseSearchTypeDTO, T extends BaseTypeDTO, ID extends Serializable, R extends BaseRepository<E, ID>, S extends BaseService<E, P, T, ID, R>>
	...
	public ResponseEntity<Response<T>> byId(
			@ApiParam("O identificador do registro. Não pode ser vazio.") @PathVariable("id") ID id) {
		try {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Registro criado com sucesso"),
			@ApiResponse(code = 400, message = "Erro de dados ou validação") })
	public ResponseEntity<Response<T>> save(@ApiParam("O registro a ser criado.") @Valid @RequestBody T object,
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Registro atualizado com sucesso"),
			@ApiResponse(code = 400, message = "Erro de dados ou validação") })
	public ResponseEntity<Response<T>> update(@ApiParam("O registro a ser atualizado.") @RequestBody T object,
